...
- Name: CheckoutStepTwoPage.spec.ts >> Checkout Step Two Page Tests >> Verify user can cancel checkout from step two and go back to cart
- Location: src\tests\CheckoutStepTwoPage.spec.ts:37:9
...
Call log:
  - waiting for locator('//a[@id=\'shopping_cart_container\']')
    - locator resolved to <a class="cart-btn" href="./cart.html" aria-label="Shopping cart" id="shopping_cart_container" data-test="shopping-cart-link">…</a>
