...
- Name: CartPage.spec.ts >> Cart Page Tests >> Verify user can navigate to inventory page by clicking on continue shopping button
- Location: src\tests\CartPage.spec.ts:34:9
