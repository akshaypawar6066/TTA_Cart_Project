...
- Name: CartPage.spec.ts >> Cart Page Tests >> Verify user is landed on cart page
- Location: src\tests\CartPage.spec.ts:26:9
...
Call log:
  - waiting for locator('//button[@data-test=\'add-to-cart-tta-practice-backpack\']')
