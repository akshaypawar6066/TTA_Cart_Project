...
- Name: CheckoutStepOnePage.spec.ts >> Checkout Step One Page Tests >> Verify user can fill checkout information and proceed to step two
- Location: src\tests\CheckoutStepOnePage.spec.ts:33:9
