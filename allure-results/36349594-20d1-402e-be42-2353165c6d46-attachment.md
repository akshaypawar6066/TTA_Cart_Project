...
```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://app.thetestingacademy.comm/playwright/ttacart/
Call log:
  - navigating to "https://app.thetestingacademy.comm/playwright/ttacart/", waiting until "load"
...
- generic [ref=e3]:
  - generic [ref=e6]:
    ...
    - paragraph [ref=e8]:
      - strong [ref=e9]: app.thetestingacademy.comm
